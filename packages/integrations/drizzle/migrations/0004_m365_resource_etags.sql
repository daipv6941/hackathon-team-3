...
CREATE UNIQUE INDEX "m365_resource_etags_uniq" ON "integrations"."m365_resource_etags" USING btree ("tenant_id","plan_link_id","resource_type","seta_id");