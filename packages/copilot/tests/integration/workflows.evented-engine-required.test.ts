...
//
// Copilot's lifecycle hook (runtime.ts) subscribes to the `workflows` pubsub
// topic and projects events into copilot.workflow_runs / workflow_approvals.
